...
ds = xr.open_dataset("short_radiation.nc")
data = ds["avg_sdswrf"].isel(valid_time=0)
...
plt.title("Surface : Annual Mean Net Shortwave Radiation (1991-2020)", fontsize=14)

# === 7. Sauvegarder et fermer ===
plt.savefig("map_surf_shortwave.png", dpi=300, bbox_inches="tight")
plt.close()
