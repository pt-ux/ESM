...
ds = xr.open_dataset("top_long_radiation.nc")
#data = ds["avg_tnlwrf"].isel(valid_time=0)
data = np.abs(ds["avg_tnlwrf"].isel(valid_time=0))
...
plt.title("TOA : Annual Mean Net Longwave Radiation (1991-2020)", fontsize=14)

# === 7. Sauvegarder et fermer ===
plt.savefig("map_top_longwave.png", dpi=300, bbox_inches="tight")
plt.close()
