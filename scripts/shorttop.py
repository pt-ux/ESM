...
ds = xr.open_dataset("top_short_radiation.nc")
data = ds["avg_tnswrf"].isel(valid_time=0)
...
plt.title("TOA : Annual Mean Net Shortwave Radiation (1991-2020)", fontsize=14)

# === 7. Sauvegarder et fermer ===
plt.savefig("map_top_shortwave.png", dpi=300, bbox_inches="tight")
plt.close()
